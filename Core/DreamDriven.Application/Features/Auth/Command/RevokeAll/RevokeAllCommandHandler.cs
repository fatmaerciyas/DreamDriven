...
namespace DreamDriven.Application.Features.Auth.Command.RevokeAll
{
    public class RevokeAllCommandHandler : BaseHandler, IRequestHandler<RevokeAllCommandRequest, Unit>
    {
        ...
        {
            List<User> users = await userManager.Users.ToListAsync(cancellationToken); //kullanicilari al

            //Her biri icin refreshToken'i null yap
